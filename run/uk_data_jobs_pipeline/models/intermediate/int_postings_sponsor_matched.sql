  ...
  create view "warehouse"."intermediate"."int_postings_sponsor_matched__dbt_tmp" as (
...
with postings as (
    ...
    select * from "warehouse"."staging"."stg_job_postings"

),

known_matches as (

    select * from "warehouse"."main"."known_sponsor_matches"
